...
func TestServiceFlagStringer(t *testing.T) {
	tests := []struct {
		...
		{0xffffffff, "SFNodeNetwork|SFNodeBloom|SFNodeWitness|SFNodeXthin|SFNodeBitcoinCash|SFNodeGraphene|SFNodeWeakBlocks|SFNodeCF|SFNodeXThinner|SFNodeNetworkLimited|0xfffffc00"},
	}
